...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); // Obiekt charakteryzujący książkę:
...
var Validator = function () {
    ...
    _createClass(Validator, null, [{
        ...
        value: function isEmptyString(value) {
            if (value.length < 0 && typeof value !== "string") throw new Error("is wrong name name or author");
        }
    }, {
        key: "isBook",
        value: function isBook(value) {
            return value instanceof Book;
        }
    }, {
        key: "isBookInLibrary",
        value: function isBookInLibrary(value) {
...
var Library = function () {
    ...
    _createClass(Library, [{
        ...
        value: function addBooks() {
            ...
            for (var _len = arguments.length, books = Array(_len), _key = 0; _key < _len; _key++) {
                books[_key] = arguments[_key];
            }

            books.forEach(function (book) {
                if (!Validator.isBook(book)) return false;
            });
            (_listBooks = this.listBooks).push.apply(_listBooks, books);
        }
    }, {
        key: "deleteBook",
        value: function deleteBook(uuid) {
            this.listBooks = this.listBooks.reduce(function (acc, el) {
                if (!el.uuid === uuid) {
                    acc.push(el);
                }
                return acc;
        ...
        key: "searchAvailableBooks",
        value: function searchAvailableBooks(phrase) {
            return this.listBooks.filter(function (book) {
                if (Validator.isEmptyString(phrase)) return "args not found";
                return book.title.toLowerCase().includes(phrase.toLowerCase()) || book.author.toLowerCase().includes(phrase.toLowerCase());
            });
        }
    }, {
        key: "searchRentBooks",
        value: function searchRentBooks(phrase) {
            return this.listRentBooks.filter(function (book) {
                if (Validator.isEmptyString(phrase)) return "args not found";
                return book.title.toLowerCase().includes(phrase.toLowerCase()) || book.author.toLowerCase().includes(phrase.toLowerCase());
            });
        }
        ...
        value: function rentABook(book) {
            ...
            var rent = new Rent().initialize(book);
            this.listRentBooks.push(rent);
            console.log(rent);
            // console.log(this.listRentBooks);
            this.listBooks = this.listBooks.filter(function (el) {
        ...
        key: "returnABook",
        value: function returnABook(book) {
            this.listBooks.push(book);
            this.listRentBooks = this.listRentBooks.filter(function (el) {
...
var Rent = function () {
    function Rent() {
        ...
        this.dateRentBook = (0, _moment2.default)().format("DD.MM.YYYY");
        this.dateReturnBook = (0, _moment2.default)().add(7, "days").format("DD.MM.YYYY");
    ...
    _createClass(Rent, [{
        key: "initialize",
        value: function initialize(book) {
            this.book = book;
            return this;
        }
    }, {
...
var book2 = new Book("pan samochodzik", "jacek dudek");
var book3 = new Book("piotr i przygody", "piotr kowalski");
var book4 = new Book("darek i przygody", "darek kowal");
var book5 = new Book("jan", "jan janiasty");
var book6 = new Book("karol", "karol karolasty");
var book7 = new Book("wojciech", "wojtek wojciechowski");
var book8 = new Book("konrad", "konrad konradowski");
var book9 = new Book("tomasz", "tomasz tomaszewski");
var book10 = new Book("adrian", "adrian adrianowski");
var book11 = new Book('damian', "damian damianowski");

var library = new Library();
// console.log(library);
library.addBooks(book, book2, book3, book4, book5, book6, book7, book8, book9, book10, book11);
